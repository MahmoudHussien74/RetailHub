...
{
    /// <inheritdoc />
    public partial class Phase3_CustomersReturnsPurchases : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnInvoices_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnInvoiceItems_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReturnInvoiceItems_InvoiceItems_InvoiceItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnInvoiceItems_BatchId",
                table: "ReturnInvoiceItems",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnInvoiceItems_InvoiceItemId",
                table: "ReturnInvoiceItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnInvoices_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnInvoices_ReturnDate",
                table: "ReturnInvoices",
                column: "ReturnDate");
            ...
            migrationBuilder.Sql("UPDATE [Invoices] SET [CustomerId] = NULL WHERE [CustomerId] IS NOT NULL AND [CustomerId] NOT IN (SELECT [Id] FROM [Customers]);");
            migrationBuilder.Sql("UPDATE [Batches] SET [SupplierId] = NULL WHERE [SupplierId] IS NOT NULL AND [SupplierId] NOT IN (SELECT [Id] FROM [Suppliers]);");
